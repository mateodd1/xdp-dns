...
const translations = {
    es: {
        ...
        "about.card_qname_desc": "En lugar de enviar el dominio completo a cada servidor en la jerarquía DNS, Unbound envía únicamente la etiqueta mínima necesaria para resolver cada paso (RFC 9156).",
        ...
        "about.card_filtering_desc": "Blocky filtra en tiempo real dominios maliciosos, publicidad invasiva, trackers y telemetría mediante listas consolidadas y verificadas sin degradar la velocidad de navegación.",
        "about.card_evasion_title": "Evasión Inteligente de Bloqueos Anycast",
        "about.card_evasion_desc": "Un proxy dinámico detecta en tiempo real rangos de IPs bloqueados indiscriminadamente por proveedores durante eventos deportivos y entrega direcciones contiguas no afectadas en IPv4 e IPv6.",
        ...
        "about.step2": "2. Borde (Caddy / dnsproxy)",
        "about.step2_desc": "Terminación TLS 1.3 / HTTP/3 QUIC de ultra-baja latencia con certificados ECDSA.",
        "about.step3": "3. Filtro (Blocky)",
        "about.step3_desc": "Inspección de listas de bloqueo, caché en memoria y reescritura de políticas.",
        "about.step4": "4. Proxy de Evasión (XDP Proxy)",
        "about.step4_desc": "Inspección inteligente ante agujeros negros Anycast de operadores.",
        "about.step5": "5. Resolver Recursivo (Unbound)",
        "about.step5_desc": "Resolución recursiva directa a los servidores raíz mundiales con validación DNSSEC y ECS stripped.",
        ...
        "about.spec_github": "Código Fuente:",
        "about.spec_github_desc": "100% Código Abierto en GitHub"
    },
    en: {
        "site.title": "xdp.es DNS",
        "theme.light": "Light",
        ...
        "about.card_qname_desc": "Instead of sending full domain names to upstream servers, Unbound sends only the minimal label required at each hierarchy level (RFC 9156).",
        ...
        "about.card_filtering_desc": "Blocky filters malicious domains, intrusive trackers, and telemetry in real time using verified blocklists without degrading resolution speed.",
        "about.card_evasion_title": "Dynamic Anycast Evasion",
        "about.card_evasion_desc": "An intelligent proxy detects anycast blackhole blocks instituted by ISPs during sporting events and serves unblocked contiguous IPv4 and IPv6 addresses.",
        ...
        "about.step2": "2. Edge (Caddy / dnsproxy)",
        "about.step2_desc": "Ultra-low latency TLS 1.3 / HTTP/3 QUIC termination with ECDSA certificates.",
        "about.step3": "3. Filter (Blocky)",
        "about.step3_desc": "Blocklist inspection, high-speed memory caching, and policy enforcement.",
        "about.step4": "4. Evasion Proxy (XDP Proxy)",
        "about.step4_desc": "Smart blackhole detection and continuous address rewrite.",
        "about.step5": "5. Recursive Resolver (Unbound)",
        "about.step5_desc": "Direct recursive queries to global root and authoritative servers with DNSSEC validation and ECS stripped.",
        ...
        "about.spec_github": "Source Code:",
        "about.spec_github_desc": "100% Open Source on GitHub"
    }
};
